...
class StockincomeSpider(Spider):
  ...
  def parse(self, response):
	...
	for month in self.monthList:
	  incomeStatementsUrl = 'http://www.cninfo.com.cn/information/stock/incomestatements_.jsp?stockCode=' + code + '&yyyy=' + str(year) + '&mm=' + month + '&cwzb=incomestatements&button2=%CC%E1%BD%BB'
	  req =  Request(incomeStatementsUrl, self.parseIncomeStatements)
