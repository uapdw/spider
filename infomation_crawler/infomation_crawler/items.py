...
class GovSubItem(Item):
	...
	content = Field()
	source = Field()
class JDBaseInfoItem(Item):
	shopurl = Field()
	shopid = Field()
class JDCommDetailItem(Item):
	ptname = Field()
	danpinname = Field()
	ptspaddress = Field()
	satisfaction = Field()
	...
	comordershow = Field()
	comfeelreply = Field()
	com_reply_name = Field()
	com_reply_addtime = Field()
	com_reply_content = Field()
	com_feel_up = Field()
	comestablishtime = Field()
	orderbuyinfo = Field()
	comid = Field()
	comidlevel = Field()
	comidaddress = Field()
	orderbuytime = Field()
class JDCommDetailReplyItem(Item):
	com_reply_name = Field()
	com_reply_addtime = Field()
	com_reply_content = Field()
class JDWaresInfoItem(Item):
	pt_name = Field()
	pt_sp_address = Field()
	name = Field()
	pinlei = Field()
	...
	danpin_intro = Field()
	danpin_spec = Field()
	danpin_package = Field()
	danpin_after_sale = Field()
	danpin_slogan = Field()
	danpin_info_detail = Field()
	danpin_price = Field()
	danpin_promotion = Field()
	danpin_stock = Field()
	danpin_fare = Field()
	danpin_payment_method = Field()
	danpin_carrier = Field()
	danpin_add_service = Field()
	danpin_credit_service = Field()
	danpin_service_tips = Field()
class JDWaresInfoTestItem(Item):
	pt_name = Field()
	pt_sp_address = Field()
	name = Field()
	pinlei = Field()
	...
	#danpin_credit_service = Field()
	danpin_service_tips = Field()
class JDSummaryCommItem(Item):
	pt_name = Field()
	danpin_name = Field()
	pt_sp_address = Field()
	com_count = Field()
	positive_com_count = Field()
	moderate_com_count = Field()
	negative_com_count = Field()
	photo_com_count = Field()
	impression = Field()
class JDDpInfoTestItem(Item):
	pt_name = Field()
	url = Field()
	score_total = Field()
	name = Field()
	...
	score_total = Field()
	service_score = Field()
	service_compare = Field()
	eff_score = Field()
	eff_compare = Field()
	Company_name = Field()
	Company_city = Field()
	Surport_service = Field()
	service_inf = Field()
class HRDataItem(Item):
	url = Field()
	websource = Field()
	name_company = Field()
	scale_company = Field()
	type_company = Field()
	dutypos = Field()
	industry_company = Field()
	website_company = Field()
	address_company = Field()
	info_company = Field()
	name_position = Field()
	keywords_position = Field()
	salary_position = Field()
	location_position = Field()
	release_time = Field()
	nature_position = Field()
	experience_position = Field()
	education_demand = Field()
	sex_requrment = Field()
	number_demand = Field()
	type_position = Field()
	jd_position = Field()
	requiremen_position = Field()
	pay_position = Field()
	welfare_position = Field()
	name_contact = Field()
	tele_contact = Field()
	email_contact = Field()
class PM25ChinaItem(Item):
	areacode = Field()
	areaname = Field()
	publishtime = Field()
	index_value = Field()
	jiankongdian_code = Field()
	jiankongdian_name = Field()
	jiangkongdian_aqi = Field()
	jiangkongdian_pm25 = Field()
	jiangkongdian_pm10 = Field()
	jiangkongdian_key = Field()
	crawltime = Field()
class TMallWaresInfoItem(Item):
	pass
class InfomationCrawlerItem(Item):
  pass

class NewMotorProductItem(Item):
  danpin_code = Field()
  pt_name = Field()
  pt_sp_address = Field()
  name = Field()
  ...
  starting_method = Field()
  front_wheel_size = Field()
  maximum_power = Field()

class NewMotorProductDynamicItem(Item):
  pt_sp_address = Field()
  pt_name = Field()
  danpin_name = Field()
  crawl_time = Field()
...
class NewMotorRateStastisticItem(Item):
  pt_name = Field()
  danpin_name = Field()
  pt_sp_address = Field()
  com_count = Field()
...
class NewMotorRateDetailItem(Item):
  pt_name = Field()
  danpin_name = Field()
  pt_sp_address = Field()
  com_feel = Field()
  com_id = Field()
  com_establish_time = Field()
