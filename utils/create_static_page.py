...
.yy-news .a-wrap{
  ...
  <div class="tech-news">
    ...
    '''
		...
		uapRes = self.searchES('web-articles','article','用友UAP AE 用友BQ UAP UDH 谢东 谢志华',10,'publishtime:desc,addtime:desc')
		j = 1
    ...
    '''
		...
		bigDataRes = self.searchES('web-articles','article','大数据 Spanner hadoop impala spark storm mahout zookeeper Oozie sqoop flume R语言 HTML5 方法 研究',10,'publishtime:desc,addtime:desc')
    ...
    '''
		...
		cloudRes = self.searchES('web-articles','article','云计算 方法 研究 算法 混合云',10,'publishtime:desc,addtime:desc')
    ...
    ''' 
		...
		mobileRes = self.searchES('web-articles','article','移动 移动信息化 移动开发平台 物联网 方法 M2M 企业移动应用平台 企业移动管理 MDM MAM MCM 移动云服务 企业移动应用商店',10,'publishtime:desc,addtime:desc')
    ...
    '''
		...
		securityRes = self.searchES('web-articles','article','安全 数据安全 云计算安全 通讯安全 服务器安全 权限 身份管理 设备管理',10,'publishtime:desc,addtime:desc')
...
def main():
	csp = CreateStaticPage("/root/sourcecode/information_crawler/web","yuqing.htm")
	csp.createPage()
	csp.uploadFileToUDN()
