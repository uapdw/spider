...
class BBSCheaaSpider(CrawlSpider):
  name = "bbscheaa"
  allowed_domains = ["bbs.cheaa.com"]
  start_urls = [
    'http://bbs.cheaa.com/forum.php?mod=forumdisplay&fid=291'
  ]

  rules = (
    Rule(LinkExtractor(allow=('forum-291-\d.html'), restrict_xpaths=('//*[@class="nxt"]'))), #前9页
  ...
  def __init__(self,**kw):
    super(BBSCheaaSpider,self).__init__(**kw)
